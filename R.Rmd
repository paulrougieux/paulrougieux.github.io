...
The following system dependencies were required:
...
doc <- read_docx() %>% 
  ...
  # Does't work this way, seems to work in existing document though
  # Maybe it can be added as a post-processing step?
