...
Insert an image from a local path

    ![](/tmp/Squirrel-in-6-step.jpg "Nussli")
...
Resize an image
    ...
    ![image](/path/to/image){width=100px}
...
To cite more than one reference separated by a semicolon:
...
Render a document as explained in `quarto help renderi`:
