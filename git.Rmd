...
Number of lines of code per language in a remote git repository according to
this [stackoverflow answer](https://stackoverflow.com/a/29012789/2641825)
...
> probably be installed with your package manager – for example, brew install
> cloc with Homebrew. There is also a docker image published under
> mribeiro/cloc. You can install the script by saving its code to a file
