...
My typical git use consists in archiving file modifications for personal projects.
Sometimes I share these projects with a colleague. 
We are then 2 persons working concurrently on the same project, pushing and pulling changes several times per day. 
...
status.
Before you leave your computer, push the content to the remote repository with:

    git push

In case you work with other people on this remote repository, 
Before you push, you might want to integrate work done by others in your repository.
If any new work has been added by others on the remote repository, git will ask you to first do:
...
This simple work flow works well for one user pulling from and pushing to the
