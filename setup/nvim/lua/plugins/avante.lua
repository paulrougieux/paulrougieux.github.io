    ...
    opts = {
      ...
      providers = {
        ...
        xai = {
          ...
          temperature = 0.2,
          max_tokens = 4096,
          -- This was turned off in November 2025 because the API reported an error 
          -- use_response_api = false,  -- https://github.com/yetone/avante.nvim/issues/2825
          -- this doesn't actually work turning off again
        },
      },
    },
    dependencies = {
