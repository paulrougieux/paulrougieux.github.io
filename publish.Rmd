...
See also the networking and hosting section in the bash page. 
...
- Atlassian page on [scrum
  sprints](https://www.atlassian.com/agile/scrum/sprints). Applies to software
  project but can also be applied to research projects. Some insights in the
  dos and don't section from that page.
