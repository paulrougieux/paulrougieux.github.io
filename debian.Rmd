...
- Based on the Stackoverflow pages I also changed
    ...
    - `dom.events.asyncClipboard.clipboardItem` set to true --> This didn't work.

Related pages:

- https://stackoverflow.com/questions/71710391/firefox-paste-text-from-clipboard-into-input
