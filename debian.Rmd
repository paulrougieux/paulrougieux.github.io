...
The Flatbed scanner
  Canoscan lide 400 is supported on Linux according to the [sane 
  backends](http://www.sane-project.org/sane-backends.html) page.
...
- [How to share your screen or at least a pdf presentation with microsoft teams
  on
...
Download the software and signature file
    ...
    cd downloads
    curl -O https://www.expressvpn.works/clients/linux/expressvpn_3.8.0.4-1_amd64.deb
    curl -O https://www.expressvpn.works/clients/linux/expressvpn_3.8.0.4-1_amd64.deb.asc
...
signature](https://www.expressvpn.com/support/vpn-setup/pgp-for-linux/)
    ...
    gpg --verify expressvpn_3.8.0.4-1_amd64.deb.asc

Install 

    sudo apt install ./expressvpn_3.8.0.4-1_amd64.deb
