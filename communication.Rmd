...
Most [emails are encrypted](https://en.wikipedia.org/wiki/Email_encryption)
at the transport layer.
End-to-end encryption would be better, but it's usage is rare. 

Through communication tools such as skype, Whatsapp or zoom you can only
communicate with people registered at the same company. This makes you
dependent on that company and creates network effects, where friends and family
members encourage you to choose the biggest platform. 
...
in a forest somewhere. It might have been recycled. It might have spent time in
a trash bin. 
...
Riot-web is a chat application based on the matrix decentralised communication
protocol. 
